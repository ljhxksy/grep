...
// tests the stripNonAlphaNum function.
void stringmanipulation_test3() {
    string test = " /Nonsense!/  said her husband, gruffly.  /You want to get out a bit ";
    string sentence = stripNonAlphaNum(test);
    istringstream iss(sentence);
    string word;
    while (iss >> word) {
        // Populate Location struct
        cout << stripNonAlphaNum(word) << " ";
    }
}
